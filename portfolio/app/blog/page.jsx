...
const Blog = () => {
            ...
            <div className="flex flex-col h-full w-full">
                <div className="flex flex-row justify-center items-center pt-10">
                    <svg height="8" width="200">
                        <defs>
                            <linearGradient id="face_left" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse">
                                <stop offset="0%" stopColor="transparent" />
                                <stop offset="30%" stopColor="var(--accent)" />
                                <stop offset="100%" stopColor="var(--accent)" />
                            </linearGradient>
                        </defs>
                        <line x1="0" y1="4" x2="190" y2="4" stroke="url(#face_left)" strokeWidth="1.5" />
                        <circle cx="190" cy="4" r="2" fill="var(--accent)" />
                    </svg>
                    <span className="text-center py-10 text-3xl font-semibold uppercase" style={{ textShadow: '0 4px 4px var(--accent)' }}>full blogs</span>
                    <svg height="8" width="200">
                        <defs>
                            <linearGradient id="fade_right" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse">
                                <stop offset="0%" stopColor="var(--accent)" />
                                <stop offset="70%" stopColor="var(--accent)" />
                                <stop offset="100%" stopColor="transparent" />
                            </linearGradient>
                        </defs>
                        <line x1="10" y1="4" x2="200" y2="4" stroke="url(#fade_right)" strokeWidth="1.5" />
        ...
        return (
            <div className="w-[85rem] h-[110rem] flex flex-col justify-center mx-auto">
                <div className="flex flex-row justify-center items-center ">
                    ...
                    <span className="text-center py-10 text-3xl font-semibold uppercase" style={{ textShadow: '0 4px 4px var(--accent)' }}>latest</span>
                    <svg height="8" width="200">
                        <defs>
                            <linearGradient id="fade_right" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse">
                                <stop offset="0%" stopColor="var(--accent)" />
    ...
    return (<div className="h-screen w-3/4 m-auto">
        {/* Body */}
        {/* {render_blogs(blogs)} */}
        {blogs.length > 0 ?
            render_latest(blogs)
